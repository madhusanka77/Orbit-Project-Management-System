...
const Register = () => {
  ...
  return (
    <div className="landing-container">
      ...
      <Particles id="tsparticles-register" init={particlesInit} options={particlesConfig} />
      ...
      <div className="content-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', position: 'relative', zIndex: 10 }}>
        ...
        <div className="auth-box" style={{ 
          ...
          <h2 className="auth-title" style={{ textAlign: 'center', marginBottom: '20px', color: '#fff' }}>Join Orbit 🚀</h2>
          ...
          <div style={{ marginTop: '20px', textAlign: 'center', fontSize: '0.9rem', color: '#cbd5e1' }}>
            Already have an account? <Link to="/login" style={{ color: '#38bdf8', fontWeight: 'bold', textDecoration: 'none' }}>Login here</Link>
          </div>
